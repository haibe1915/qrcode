...
class MainActivity: FlutterActivity() {
  ...
  override fun cleanUpFlutterEngine(flutterEngine: FlutterEngine) {
    ...
    GoogleMobileAdsPlugin.unregisterNativeAdFactory(flutterEngine, "adFactoryLanguage")
  }
}
...
class NativeAdFactoryLanguage: NativeAdFactory {
  private var layoutInflater: LayoutInflater
  ...
  override fun createNativeAd(nativeAd: NativeAd?, customOptions: MutableMap<String, Any>?): NativeAdView {
    val adView = layoutInflater.inflate(R.layout.language_native_ad, null) as NativeAdView
