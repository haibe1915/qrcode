...
class _EventToQrPageState extends State<EventToQrPage> {
  ...
  void initState() {
    super.initState();
    importantField = [_titleEditingController];
  }
            ...
            onPressed: () {
              if (checkEmpty()) {
                var data = 'BEGIN:VCALENDAR\n'
                    ...
                    'SUMMARY:${_titleEditingController.text.trimRight()}\n'
                    'DESCRIPTION:${_describeEditingController.text.trimRight()}\n'
                    'LOCATION:${_locationEditingController.text.trimRight()}\n'
                    'END:VEVENT\n'
                    'END:VCALENDAR';
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        if (importantField
                                            .contains(_titleEditingController))
                                          const Column(
                                            mainAxisAlignment:
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          if (importantField
                                              .contains(_urlEditingController))
                                            const Text(
                                              '*',
                                              style:
                                                  TextStyle(color: Colors.red),
                                    ...
                                    Container(
                                      ...
                                      child: Center(
                                          child: StreamBuilder(
                                        stream: _streamStartDateTimeController
                                            .stream,
